                                    ...
                                    <tbody>
                                        ...
                                        foreach ($compras_datos as $compras_dato) {
                                            ...
                                            <tr>
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" value="<?php echo number_format($compras_dato['precio_venta_producto'], 0, '', '.'); ?>" class="form-control" disabled>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-3">
                                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <a href="https://wa.me/+595<?php echo $compras_dato['celular_proveedor']; ?>" target="_blank" class="btn btn-success">
                                                ...
                                                <td><?php echo number_format($compras_dato['precio_compra'], 0, '', '.'); ?></td>
